...
The admin screen uses a scoped modern panel layout with a compact status header, summary stats, cleaner pagination, and two-column email update settings to reduce scrolling.
